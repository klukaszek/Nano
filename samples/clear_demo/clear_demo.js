...
Module['FS_createPath']("/", "wgpu-shaders", true, true);
    ...
    loadPackage({"files": [{"filename": "/wgpu-shaders/cimgui-wgpu.wgsl", "start": 0, "end": 780}, {"filename": "/wgpu-shaders/collatz.wgsl", "start": 780, "end": 1907}, {"filename": "/wgpu-shaders/compute-wgpu.wgsl", "start": 1907, "end": 2309}, {"filename": "/wgpu-shaders/particle_compute.wgsl", "start": 2309, "end": 4976}, {"filename": "/wgpu-shaders/particle_render.wgsl", "start": 4976, "end": 6259}, {"filename": "/wgpu-shaders/uv-triangle.wgsl", "start": 6259, "end": 6968}], "remote_package_size": 6968});

  })();

// end include: /tmp/tmpj_dogwmh.js
// include: /tmp/tmp1pfdf7ne.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['ENVIRONMENT_IS_PTHREAD'] || Module['$ww']) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp1pfdf7ne.js
// include: /tmp/tmpbji7m1p2.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpbji7m1p2.js
...
var wasmBinaryFile;
  wasmBinaryFile = 'clear_demo.wasm';
